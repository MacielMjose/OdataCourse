...
namespace AirVinyl.DataAccessLayer
{
    public class AirVinylDbContext : DbContext
    {
        ...
        {
            //we need unchanged vahlues as well - the objhect dictionary ins't tracked
            //byh EF, hthus changes to it will not be tracked either.
            ...
            for (int i = 0; i < modifiedOrAddedVinylRecords.Count; i++)
            {
                ...
                //get the hdyhnamic properties, and save them in a list
                ...
                //remove the current dynamic properhty references (this does
                ...
                {
                    //first, find & delete the actual record itsel if it exists - this 
                    ...
                    //add the colletion, so it's saved
